...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('program_kerja_spi', function (Blueprint $table) {
            $table->id();

            // ===== Jenis Program Kerja =====
            $table->enum('jenis', ['audit', 'reviu', 'monev']); // ✅ jenis program kerja

            // ===== MATERI POKOK PROGRAM KERJA =====
            $table->string('judul');
    ...
    {
        Schema::dropIfExists('program_kerja_spi');
    }
};
