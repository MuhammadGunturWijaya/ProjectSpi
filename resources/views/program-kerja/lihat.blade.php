...
<body>
    ...
    <div class="container">
        ...
        <div class="document-grid">
            @forelse($programKerjaList as $programKerja)
                <div class="document-card">
                    <div class="card-icon">
                        <i class="fa fa-file-alt"></i>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">{{ $programKerja->judul }}</h3>
                        <p class="card-subtitle">Tahun: {{ $programKerja->tahun ?? '-' }}</p>
                    </div>
                    <div class="card-actions">
                        <a href="{{ route('programKerja.show', $programKerja->id) }}" class="action-btn view-btn">
                            <i class="fa fa-eye"></i> Lihat
                        </a>

                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('programKerja.edit', $programKerja->id) }}" class="action-btn edit-btn">
            ...
            @empty
                <p class="no-data-message">Tidak ada data Program Kerja SPI {{ ucfirst($jenis) }}.</p>
            @endforelse
        </div>
    </div>
