        ...
        <div class="document-grid">
            @forelse($peningkatans as $peningkatan)
                <div class="document-card">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">{{ $peningkatan->judul }}</h3>
                        <p class="card-subtitle">Tahun: {{ $peningkatan->tahun ?? '-' }}</p>
                    </div>
                    <div class="card-actions">
                        <a href="{{ route('peningkatanKualitas.show', $peningkatan->id) }}" class="action-btn view-btn">
                            <i class="fa fa-eye"></i> Lihat
                        </a>

                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('peningkatanKualitas.edit', $peningkatan->id) }}" class="action-btn edit-btn">
                                <i class="fa fa-edit"></i> Edit
                            </a>

                            <form action="{{ route('peningkatanKualitas.destroy', $peningkatan->id) }}" method="POST"
            ...
            @empty
                <p class="no-data-message">Tidak ada data Peningkatan Kualitas.</p>
            @endforelse
        </div>
    </div>
