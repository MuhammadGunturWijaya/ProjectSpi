        ...
        <div class="document-grid">
            @forelse($piagams as $piagam)
                <div class="document-card">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">{{ $piagam->judul }}</h3>
                        <p class="card-subtitle">Tahun: {{ $piagam->tahun ?? '-' }}</p>
                    </div>
                    <div class="card-actions">
                        <a href="{{ route('piagam.show', $piagam->id) }}" class="action-btn view-btn">
                            <i class="fa fa-eye"></i> Lihat
                        </a>

                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('piagam.edit', $piagam->id) }}" class="action-btn edit-btn">
                                <i class="fa fa-edit"></i> Edit
                            </a>

                            <form action="{{ route('piagam.destroy', $piagam->id) }}" method="POST" class="inline-form"
            ...
            @empty
                <p class="no-data-message">Tidak ada data piagam SPI.</p>
            @endforelse
        </div>
    </div>
