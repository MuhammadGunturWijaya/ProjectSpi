    ...
    <main class="container">
        <div class="main-content">
            <div class="left-column">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2><i class="fas fa-info-circle"></i> Ringkasan piagam SPI</h2>
                        <a href="#" class="btn-primary openPopup" data-id="{{ $piagam->id }}">
                            Lihat Selengkapnya
                        </a>
                    </div>
                    <p class="abstract-content">
                        {{ $piagam->abstrak ?? 'Tidak ada ringkasan tersedia.' }}
                    </p>
                </div>
                ...
                <div class="card" style="margin-top: 2rem;">
                    <div class="card-header">
                        <h2><i class="fas fa-tags"></i> Metadata piagam SPI</h2>
                    </div>
                    <dl class="metadata-grid">
                        <div class="metadata-item">
                            <dt>Tipe Dokumen</dt>
                            <dd>{{ $piagam->tipe_dokumen ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Judul</dt>
                            <dd>{{ $piagam->judul_meta ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>T.E.U.</dt>
                            <dd>{{ $piagam->teu ?? '-' }}</dd>
                        ...
                        <div class="metadata-item">
                            ...
                            <dd>{{ $piagam->bentuk_singkat ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tahun</dt>
                            <dd>{{ $piagam->tahun_meta ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tempat Penetapan</dt>
                            <dd>{{ $piagam->tempat_penetapan ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tanggal Penetapan</dt>
                            <dd>{{ $piagam->tanggal_penetapan?->format('d F Y') ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tanggal Pengundangan</dt>
                            <dd>{{ $piagam->tanggal_pengundangan?->format('d F Y') ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tanggal Berlaku</dt>
                            <dd>{{ $piagam->tanggal_berlaku?->format('d F Y') ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Sumber</dt>
                            <dd>{{ $piagam->sumber ?? '-' }}</dd>
                    ...
                    <div class="social-share">
                        <span class="share-text">
                            Halaman ini telah diakses {{ $piagam->view_count ?? 0 }} kali
                        </span>
                ...
                <div class="card" style="margin-top: 2rem;">
                    ...
                    <p class="abstract-content">{{ $piagam->uji_materi ?? 'Belum Tersedia' }}</p>
                </div>
            </div>
            ...
            <div class="right-column">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2><i class="fas fa-file-download"></i> File piagam SPI</h2>
                    </div>
                    <div class="file-card-content">
                        <i class="fas fa-file-pdf file-icon"></i>
                        <div class="file-name">{{ $piagam->file_pdf ?? 'Tidak ada file' }}</div>
                        <div class="btn-group">
                            @php
                                $filePath = $piagam->file_pdf
                                    ? asset('storage/' . trim($piagam->file_pdf))
                                    : null;
                            @endphp
                    ...
                    <div class="card" style="margin-top: 2rem;">
                        <div class="card-header">
                            <h2><i class="fas fa-check-circle"></i> Status piagam SPI</h2>
                        </div>
                            ...
                            @if($piagam->mencabut)
                                <div class="status-item">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            @foreach(explode("\n", str_replace("\r", '', $piagam->mencabut)) as $item)
                                                <li>{{ $item }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
