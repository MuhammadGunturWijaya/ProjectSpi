        ...
        <div class="document-grid">
            @forelse($penataans as $penataan)
                <div class="document-card">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">{{ $penataan->judul }}</h3>
                        <p class="card-subtitle">Tahun: {{ $penataan->tahun ?? '-' }}</p>
                    </div>
                    <div class="card-actions">
                        <a href="{{ route('penataan.show', $penataan->id) }}" class="action-btn view-btn">
                            <i class="fa fa-eye"></i> Lihat
                        </a>

                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('penataan.edit', $penataan->id) }}" class="action-btn edit-btn">
                                <i class="fa fa-edit"></i> Edit
                            </a>

                            <form action="{{ route('penataan.destroy', $penataan->id) }}" method="POST" class="inline-form"
            ...
            @empty
                <p class="no-data-message">Tidak ada data Penataan Tata Kelola.</p>
            @endforelse
        </div>
    </div>
