        ...
        <div class="document-grid">
            @forelse($konsiderans as $Konsideran)
                <div class="document-card">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">{{ $Konsideran->judul }}</h3>
                        <p class="card-subtitle">Tahun: {{ $Konsideran->tahun ?? '-' }}</p>
                    </div>
                    <div class="card-actions">
                        <a href="{{ route('konsideran.show', $Konsideran->id) }}" class="action-btn view-btn">
                            <i class="fa fa-eye"></i> Lihat
                        </a>

                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('konsideran.edit', $Konsideran->id) }}" class="action-btn edit-btn">
                                <i class="fa fa-edit"></i> Edit
                            </a>

                            <form action="{{ route('konsideran.destroy', $Konsideran->id) }}" method="POST" class="inline-form"
            ...
            @empty
                <p class="no-data-message">Tidak ada data Konsideran SPI.</p>
