            ...
            <div class="left-column">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="#" class="btn-primary openPopup" data-id="{{ $PosAp->id }}">
                            Lihat Selengkapnya
                        </a>
                    </div>
                    <p class="abstract-content">
                        {{ $PosAp->abstrak ?? 'Tidak ada ringkasan tersedia.' }}
                    </p>
                </div>
                ...
                <div class="card" style="margin-top: 2rem;">
                    ...
                    <dl class="metadata-grid">
                        <div class="metadata-item">
                            <dt>Tipe Dokumen</dt>
                            <dd>{{ $PosAp->tipe_dokumen ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Judul</dt>
                            <dd>{{ $PosAp->judul_meta ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>T.E.U.</dt>
                            <dd>{{ $PosAp->teu ?? '-' }}</dd>
                        ...
                        <div class="metadata-item">
                            ...
                            <dd>{{ $PosAp->bentuk_singkat ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tahun</dt>
                            <dd>{{ $PosAp->tahun_meta ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tempat Penetapan</dt>
                            <dd>{{ $PosAp->tempat_penetapan ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tanggal Penetapan</dt>
                            <dd>{{ $PosAp->tanggal_penetapan?->format('d F Y') ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tanggal Pengundangan</dt>
                            <dd>{{ $PosAp->tanggal_pengundangan?->format('d F Y') ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Tanggal Berlaku</dt>
                            <dd>{{ $PosAp->tanggal_berlaku?->format('d F Y') ?? '-' }}</dd>
                        </div>
                        <div class="metadata-item">
                            <dt>Sumber</dt>
                            <dd>{{ $PosAp->sumber ?? '-' }}</dd>
                    ...
                    <div class="social-share">
                        <span class="share-text">Halaman ini telah diakses {{ $PosAp->view_count ?? 0 }} kali</span>
                ...
                <div class="card" style="margin-top: 2rem;">
                    ...
                    <p class="abstract-content">{{ $PosAp->uji_materi ?? 'Belum Tersedia' }}</p>
                </div>
            </div>
            ...
            <div class="right-column">
                ...
                <div class="card">
                    ...
                    <div class="file-card-content">
                        ...
                        <div class="file-name">{{ $PosAp->file_pdf ?? 'Tidak ada file' }}</div>
                        <div class="btn-group">
                            @php
                                $filePath = $PosAp->file_pdf
                                    ? asset('storage/' . trim($PosAp->file_pdf))
                                    : null;
                            @endphp

                            <div class="btn-group">
                                @if ($filePath)
                                    <a href="{{ asset('storage/' . $PosAp->file_pdf) }}" target="_blank" class="btn btn-primary">Preview</a>
                            ...
                            @if($PosAp->mencabut)
                                <div class="status-item">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            @foreach(explode("\n", str_replace("\r", '', $PosAp->mencabut)) as $item)
                                                <li>{{ $item }}</li>
                                            @endforeach
