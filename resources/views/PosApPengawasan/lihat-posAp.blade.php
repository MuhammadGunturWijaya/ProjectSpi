...
<body>
    ...
    <div class="container">
        ...
        <div class="document-grid">
            @forelse($posAps as $PosAp)
                <div class="document-card">
                    <div class="card-icon">
                        <i class="fa fa-file-alt"></i>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">{{ $PosAp->judul }}</h3>
                    ...
                    <div class="card-actions">
                        ...
                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('posAp.edit', $PosAp->id) }}" class="action-btn edit-btn">
                                <i class="fa fa-edit"></i> Edit
                            </a>

                            <form action="{{ route('posAp.destroy', $PosAp->id) }}" method="POST" class="inline-form"
            ...
            @empty
                <p class="no-data-message">Tidak ada data POS AP {{ ucfirst($jenis) }}.</p>
            @endforelse
        </div>
    </div>
