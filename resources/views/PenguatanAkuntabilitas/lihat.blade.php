...
<body>
    ...
    <div class="document-grid">
        @forelse($penguatans as $penguatanAkuntabilitas)
            <div class="document-card">
                <div class="card-icon">
                    <i class="fa fa-file-alt"></i>
                </div>
                <div class="card-body">
                    <h3 class="card-title">{{ $penguatanAkuntabilitas->judul }}</h3>
                    <p class="card-subtitle">Tahun: {{ $penguatanAkuntabilitas->tahun ?? '-' }}</p>
                </div>
                <div class="card-actions">
                    <a href="{{ route('penguatanAkuntabilitas.show', $penguatanAkuntabilitas->id) }}" class="action-btn view-btn">
                        <i class="fa fa-eye"></i> Lihat
                    </a>

                    @if(Auth::check() && Auth::user()->role === 'admin')
                        <a href="{{ route('penguatanAkuntabilitas.edit', $penguatanAkuntabilitas->id) }}" class="action-btn edit-btn">
                            <i class="fa fa-edit"></i> Edit
                        </a>

                        <form action="{{ route('penguatanAkuntabilitas.destroy', $penguatanAkuntabilitas->id) }}" method="POST"
        ...
        @empty
            <p class="no-data-message">Tidak ada data Penguatan Akuntabilitas.</p>
        @endforelse
    </div>
</div>
