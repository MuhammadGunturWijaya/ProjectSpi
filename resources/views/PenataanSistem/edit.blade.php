    ...
    <div class="container py-5">
        <div class="text-center mb-5">
            ...
            <p class="text-muted fs-6">
                Perbarui informasi dan metadata dokumen penataan sistem dengan mudah.
            </p>
        </div>
        ...
        <form action="{{ route('penataanSistem.update', $penataan->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="abstrak" name="abstrak"
                                    rows="4">{{ old('abstrak', $penataan->abstrak) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="catatan" class="form-label fw-semibold">Catatan</label>
                                <textarea class="form-control" id="catatan" name="catatan"
                                    rows="3">{{ old('catatan', $penataan->catatan) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow-sm border-0 h-100">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="mencabut" name="mencabut"
                                        rows="3">{{ old('mencabut', $penataan->mencabut) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end mt-5">
                                ...
                                <a href="{{ route('penataanSistem.index') }}" class="btn btn-outline-secondary fw-semibold">
                                    Batal
                                </a>
                            </div>
                        </div>
