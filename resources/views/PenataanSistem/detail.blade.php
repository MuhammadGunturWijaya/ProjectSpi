    ...
    <main class="container">
        <div class="main-content">
            <div class="left-column">
                <!-- Ringkasan Penataan Sistem -->
                <div class="card">
                    <div class="card-header">
                        <h2><i class="fas fa-info-circle"></i> Ringkasan Penataan Sistem</h2>
                ...
                <!-- Metadata Penataan Sistem -->
                <div class="card" style="margin-top: 2rem;">
                    <div class="card-header">
                        <h2><i class="fas fa-tags"></i> Metadata Penataan Sistem</h2>
                    </div>
            ...
            <div class="right-column">
                <!-- File Penataan Sistem -->
                <div class="card">
                    <div class="card-header">
                        <h2><i class="fas fa-file-download"></i> File Penataan Sistem</h2>
                    </div>
                    ...
                    <!-- Status Penataan Sistem -->
                    <div class="card" style="margin-top: 2rem;">
                        <div class="card-header">
                            <h2><i class="fas fa-check-circle"></i> Status Penataan Sistem</h2>
                        </div>
