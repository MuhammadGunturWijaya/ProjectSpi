...
<body>
    ...
    <div class="container">
        ...
        <div class="document-grid">
            @forelse($penataans as $penataanSistem)
                <div class="document-card">
                    <div class="card-icon">
                        <i class="fa fa-file-alt"></i>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">{{ $penataanSistem->judul }}</h3>
                        <p class="card-subtitle">Tahun: {{ $penataanSistem->tahun ?? '-' }}</p>
                    </div>
                    <div class="card-actions">
                        <a href="{{ route('penataanSistem.show', $penataanSistem->id) }}" class="action-btn view-btn">
                            <i class="fa fa-eye"></i> Lihat
                        </a>

                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('penataanSistem.edit', $penataanSistem->id) }}" class="action-btn edit-btn">
                                <i class="fa fa-edit"></i> Edit
                            </a>

                            <form action="{{ route('penataanSistem.destroy', $penataanSistem->id) }}" method="POST"
            ...
            @empty
                <p class="no-data-message">Tidak ada data Penataan Sistem.</p>
            @endforelse
        </div>
    </div>
