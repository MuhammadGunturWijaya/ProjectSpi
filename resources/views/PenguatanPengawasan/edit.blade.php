    ...
    <div class="container py-5">
        <div class="text-center mb-5">
            ...
            <p class="text-muted fs-6">
                Perbarui informasi dan metadata dokumen Penguatan Pengawasan dengan mudah.
            </p>
        </div>
        ...
        <form action="{{ route('penguatanPengawasan.update', $penguatan->id) }}" method="POST"
                    ...
                    <div class="card shadow-sm border-0 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end mt-5">
                                ...
                                <a href="{{ route('penguatanPengawasan.index') }}"
