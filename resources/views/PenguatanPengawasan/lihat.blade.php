        ...
        <div class="document-grid">
            @forelse($penguatans as $penguatan)
                <div class="document-card">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">{{ $penguatan->judul }}</h3>
                        <p class="card-subtitle">Tahun: {{ $penguatan->tahun ?? '-' }}</p>
                    </div>
                    <div class="card-actions">
                        <a href="{{ route('penguatanPengawasan.show', $penguatan->id) }}" class="action-btn view-btn">
                            <i class="fa fa-eye"></i> Lihat
                        </a>

                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('penguatanPengawasan.edit', $penguatan->id) }}" class="action-btn edit-btn">
                                <i class="fa fa-edit"></i> Edit
                            </a>

                            <form action="{{ route('penguatanPengawasan.destroy', $penguatan->id) }}" method="POST"
            ...
            @empty
                <p class="no-data-message">Tidak ada data Penguatan Pengawasan.</p>
            @endforelse
        </div>
    </div>
