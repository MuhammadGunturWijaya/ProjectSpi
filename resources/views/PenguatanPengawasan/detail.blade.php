    ...
    <main class="container">
        <div class="main-content">
            <div class="left-column">
                <!-- Ringkasan Penguatan penguatan -->
                <div class="card">
                    <div class="card-header">
                        <h2><i class="fas fa-info-circle"></i> Ringkasan Penguatan penguatan</h2>
                ...
                <!-- Metadata Penguatan penguatan -->
                <div class="card" style="margin-top: 2rem;">
                    <div class="card-header">
                        <h2><i class="fas fa-tags"></i> Metadata Penguatan penguatan</h2>
                    </div>
            ...
            <div class="right-column">
                <!-- File Penguatan penguatan -->
                <div class="card">
                    <div class="card-header">
                        <h2><i class="fas fa-file-download"></i> File Penguatan penguatan</h2>
                    </div>
                    ...
                    <!-- Status Penguatan penguatan -->
                    <div class="card" style="margin-top: 2rem;">
                        <div class="card-header">
                            <h2><i class="fas fa-check-circle"></i> Status Penguatan penguatan</h2>
                        </div>
